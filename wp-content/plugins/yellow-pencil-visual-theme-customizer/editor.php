...
<head>
	...
	if($currentRevision == false){
		$classes[] = 'yp-customizations-empty';	
	}
...
<body class="<?php echo trim($classesReturn); ?>">
	...
	<div class="top-area-btn-group">
		...
		<div data-toggle='tooltip-bar' data-placement='right' title='Element Inspector <span class="yp-s-shortcut">(V)</span>' class="top-area-btn cursor-main-btn yp-selector-mode active"><span class="no-aiming-icon"></span><span class="aiming-icon"></span><span class="sharp-selector-icon"></span></div>
