		...
		<li class='animation-option'>
			...
			<div class='yp-this-content'>
				...
				if($filter_animation_tools){
					...
					<a class='yp-advanced-link yp-just-desktop yp-add-animation-link'>Create Animation</a>
					</div>";
				}
			    ...
			    if($transition_status){
					...
					".yp_get_select_markup(
						...
						array(
							...
							'background-x-position' => 'background-x-position',
							'background-y-position' => 'background-y-position',
