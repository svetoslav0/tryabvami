...
function yp_welcome_screen_content(){
  ...
  <div class="wrap yp-page-welcome about-wrap">
	...
	<div class="yp-welcome-tab">
		...
		<img class="yp-featured-img" src="<?php echo WT_PLUGIN_URL; ?>images/promo.svg" />
	...
	<div class="yp-welcome-feature feature-section">
		...
		<div class="yp-column">
			<img class="yp-img-center" src="<?php echo WT_PLUGIN_URL; ?>images/promo-1.svg">
		...
		<div class="yp-column">
			<img class="yp-img-center" src="<?php echo WT_PLUGIN_URL; ?>images/promo-2.svg">
		...
		<div class="yp-column">
			<img class="yp-img-center" src="<?php echo WT_PLUGIN_URL; ?>images/promo-3.svg">
